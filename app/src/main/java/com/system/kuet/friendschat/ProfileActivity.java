    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsersDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                LoadProfilePic2(user_id, mProfileImage);
                   ...
                   mFriendReqDatabase.child(mcurrent_user.getUid()).child(user_id).child("request_type").setValue("sent").addOnCompleteListener(new OnCompleteListener<Void>() {
                       ...
                       public void onComplete(@NonNull Task<Void> task) {
                           if (task.isSuccessful()) {
                               mFriendReqDatabase.child(mcurrent_user.getUid()).child(mcurrent_user.getUid()).child("request_type").setValue("received").addOnSuccessListener(new OnSuccessListener<Void>() {
                                   public void onSuccess(Void aVoid) {
